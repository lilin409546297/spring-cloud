...
public class InitData implements CommandLineRunner{
    ...
    private void initOauth2() {
        ...
        if (oauthClientDetailsList.size() == 0) {
            ...
            oauthClientDetails.setWebServerRedirectUri("http://127.0.0.1:8695");
            oauthClientDetails.setAutoapprove("false");

            OauthClientDetails oauthClientDetailsSSO = new OauthClientDetails();
            ...
            oauthClientDetailsSSO.setAutoapprove("true");

            oauthClientDetailsRepository.save(oauthClientDetails);
            oauthClientDetailsRepository.save(oauthClientDetailsSSO);
        }
    }
